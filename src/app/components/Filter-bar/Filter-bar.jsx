...
export default function Filter_bar() {
  ...
  // Updated handleCategoryChange to prevent unchecking the checked checkbox
  const handleCategoryChange = (id) => {
    if (selectedCategoryId === id) {
      // Already selected, do nothing to keep it checked
      return;
    }
    // Select new category and update context
